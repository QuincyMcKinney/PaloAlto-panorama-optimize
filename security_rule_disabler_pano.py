...
Features:
- Panorama only
- Prompts for target Device Group
- Queries BOTH Pre-Rulebase and Post-Rulebase
- Generates a CSV report of results (PRE/POST)
- Uses user-configurable rate limiting for write (SET) operations
